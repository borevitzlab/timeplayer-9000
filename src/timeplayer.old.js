/**
 * Created by stormaes on 9/02/17.
 */
    ...
    var hiresButton = {
        ...
        clickedCallback: (d) => {
            ...
            let s1 = this.botLineGradientStops.data(this.gradientData, (d) => d.index),
                s2 = this.topLineGradientStops.data(this.gradientData, (d) => d.index);
